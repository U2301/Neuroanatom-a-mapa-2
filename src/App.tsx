...
import { PlanimetryView } from './components/PlanimetryView';
import { NeuronMatrixView } from './components/NeuronMatrixView';
import { MeningesLcrView } from './components/MeningesLcrView';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<MainTab>('planimetry');
    ...
    <div className="min-h-screen bg-[#fdfbf7] text-[#231f1c] font-sans selection:bg-[#ffb692] selection:text-[#292420] flex flex-col relative overflow-x-hidden">
      <AnimatePresence mode="wait">
        {currentScreen === 'backup' ? (
          /* =========================================================
             SCREEN 2: Neuroanatomía Original Backup
             Clicking anywhere on body pushes back to Screen 1
             ========================================================= */
          ...
          /* =========================================================
             SCREEN 1: Neuroanatomía - Atlas de Estudio de Clase
             ========================================================= */
          <motion.div
            key="screen-atlas"
          ...
          >
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#edf5f0] border border-[#2b553c]/30 flex items-center justify-center text-[#2b553c] flex-shrink-0">
                      <Rat className="w-6 h-6 text-[#2b553c]" />
                    </div>
                    <div>
                      <h1 className="text-xl sm:text-2xl font-bold font-serif text-[#292420] tracking-tight">
                        Neuroanatomía
                      </h1>
                      <p className="text-xs text-[#787169]">
                        Planimetría • Cisuras y Lóbulos • Neurona y Matriz • Meninges y LCR
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5 flex-wrap">
                    <div className="relative flex-grow sm:w-64">
                      ...
                      <input
                        ...
                        placeholder="Buscar tema, lóbulo o corte..."
                ...
                >
                  <button
                    onClick={() => setActiveTab('planimetry')}
                    className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm font-medium rounded-lg transition cursor-pointer whitespace-nowrap ${
                      activeTab === 'planimetry'
                        ? 'bg-[#2b553c] text-white shadow-xs'
                        : 'text-[#49423c] hover:text-[#231f1c] hover:bg-[#f5efe9]'
                    }`}
                  >
                    <Split className="w-4 h-4" />
                    <span>Planimetría y Lóbulos</span>
                  </button>
                  ...
                  >
                    ...
                    <span>Neurona y Matriz</span>
                  </button>

                  <button
                    onClick={() => setActiveTab('meninges')}
                    className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm font-medium rounded-lg transition cursor-pointer whitespace-nowrap ${
                      activeTab === 'meninges'
                        ? 'bg-[#6d4304] text-white shadow-xs'
                        : 'text-[#49423c] hover:text-[#231f1c] hover:bg-[#f5efe9]'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm font-medium rounded-lg transition cursor-pointer whitespace-nowrap ${
                      activeTab === 'graph'
                        ? 'bg-[#944920] text-white shadow-xs'
                        : 'text-[#49423c] hover:text-[#231f1c] hover:bg-[#f5efe9]'
                    }`}
                  >
            ...
            <main className="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
              {activeTab === 'planimetry' && <PlanimetryView />}
              {activeTab === 'neuron' && <NeuronMatrixView />}
              {activeTab === 'meninges' && <MeningesLcrView />}
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-[#787169]">
                      Diseñado con rigor académico y basado exclusivamente en la información de clase.
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-4 text-[#787169] text-[11px]">
                  ...
                  <button
                    ...
                    className="hover:text-[#2b553c] transition font-medium cursor-pointer"
                  >
                    Backup Original
                  </button>
                  <span>•</span>
